...
namespace CatalogusTest
{
    ...
    public class TestIBibItem
    {
        ...
        public void TestVoegToe()
        {
            ...
            // tijdschrift
            IBibItem tijdschrift = new TijdSchrift { Id = "ID03", Titel = "Scientific American", Datum = new DateTime(2014, 8, 1), Uitgeverij = "Scientific American" };
        ...
        public void TestZoekTrefwoord()
        {
            ...
            Assert.IsTrue(item.ZoekTrefwoord("s").Contains(item));
            // tijdschrift
            item = new TijdSchrift { Id = "ID03", Titel = "Scientific American", Datum = new DateTime(2014, 8, 1), Uitgeverij = "Scientific American" };
            IBibItem artikel = new Artikel { Id = "ID04", Titel = "Planets we could call home", Auteur = "Dimitar Sasselov" };
            ...
            // tijdschrift
            IBibItem tijdschrift = new TijdSchrift { Id = "ID01", Titel = "Scientific American", Datum = new DateTime(2014, 8, 1), Uitgeverij = "Scientific American" };
